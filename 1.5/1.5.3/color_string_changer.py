...
def color_changed(new_intval):
    fill_color = '#' + hexstring(red_intvar) + hexstring(green_intvar) + '00'
    canvas.itemconfig(circle_item, fill=fill_color)
...
circle_item = canvas.create_oval(50, 50, 250, 250, 
                                 outline='#000000', fill='#7f7f00')
